...
def population_constraint
  ...
  from countries
  where population >
  (select population from countries where name = 'Canada') and population < (select population from countries where name = 'Poland')
  SQL
end
...
def sparse_continents
 ...
 -- select all continents then say not in for 
-- find the continent which has each country less than 2500000000
